...
public abstract class T3VersierterSpieler extends T3Spieler {
	 ...
	 */
	protected Vector<T3FeldPos> leere_felder(char[][] feld) {
		Vector<T3FeldPos> list = new Vector<T3FeldPos>();
	 ...
	 */
	protected Vector<T3FeldPos> gewinnfelder(char v, char[][] feld) {
		Vector<T3FeldPos> gewinnfelder = new Vector<T3FeldPos>();
